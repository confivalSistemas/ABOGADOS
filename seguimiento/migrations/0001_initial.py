    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actividad', models.ForeignKey(blank=True, db_column='actividad', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='Seguimiento.actividad+', to='seguimiento.TipoSeguimiento')),
                ('estado', models.ForeignKey(blank=True, db_column='estado', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='Seguimiento.estado+', to='seguimiento.Subitemseguimiento')),
                ('nombre', models.ForeignKey(blank=True, db_column='nombre', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='seguimiento.AsesoresDb')),
                ('nombre_apellido', models.ForeignKey(blank=True, db_column='nombre_apellido', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='seguimiento.DbAbogados')),
            ],
            options={
